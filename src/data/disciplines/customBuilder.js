...
const HYROX_POOL = [
  ...
  { id:'burpee',        he:'Burpees',                    needs:[], reps:[10,20], quality:'engine' },
  { id:'burpee_broad',  he:'Burpee Broad Jumps',         needs:[], reps:[8,15],  quality:'engine', station:'Burpee Broad Jump' },
  { id:'air_squat',     he:'Air Squats',                 needs:[], reps:[20,40], quality:'legs' },
  { id:'jump_squat',    he:'Jump Squats',                needs:[], reps:[15,25], quality:'legs' },
  { id:'lunge_walk',    he:'Walking Lunges (צעדים)',     needs:[], reps:[20,40], quality:'legs', standsFor:'Sandbag Lunges' },
  { id:'mountain',      he:'Mountain Climbers',          needs:[], reps:[30,50], quality:'engine' },
  { id:'bear_crawl',    he:'Bear Crawl (מטרים)',         needs:[], reps:[15,30], quality:'grind', standsFor:'Sled Push' },
  { id:'plank_pull',    he:'Superman Pulls',             needs:[], reps:[15,25], quality:'pull',  standsFor:'Sled Pull' },
  { id:'pushup',        he:'Push-ups',                   needs:[], reps:[10,25], quality:'push' },
  { id:'sit_up',        he:'Sit-ups',                    needs:[], reps:[20,35], quality:'core' },
  { id:'high_knees',    he:'High Knees (שניות)',         needs:[], reps:[30,60], quality:'engine' },
  { id:'wall_sit',      he:'Wall Sit (שניות)',           needs:[], reps:[30,60], quality:'legs' },
  { id:'squat_press',   he:'Squat to Press (ידיים ריקות)', needs:[], reps:[20,30], quality:'legs', standsFor:'Wall Balls' },

  // Running / distance
  { id:'run',           he:'ריצה (מטרים)',               needs:['space'], reps:[200,600], quality:'run', station:'Run' },
  { id:'shuttle',       he:'Shuttle Run 20m (סבבים)',    needs:['space'], reps:[6,12],   quality:'run', standsFor:'Run' },

  // Loaded carries and lifts
  { id:'bp_lunge',      he:'Backpack Lunges (צעדים)',    needs:['backpack','dumbbell'], reps:[20,40], quality:'legs', station:'Sandbag Lunges' },
  { id:'bp_carry',      he:'Loaded Carry (מטרים)',       needs:['backpack','dumbbell'], reps:[40,100], quality:'grind', station:'Farmers Carry' },
  { id:'bp_thruster',   he:'Backpack Thrusters',         needs:['backpack','dumbbell'], reps:[12,20], quality:'legs', standsFor:'Wall Balls' },
  { id:'bp_squat',      he:'Loaded Squats',              needs:['backpack','dumbbell'], reps:[15,30], quality:'legs' },
  { id:'db_snatch',     he:'DB Snatch (לסירוגין)',       needs:['dumbbell'], reps:[16,30], quality:'engine' },
  { id:'db_swing',      he:'KB / DB Swings',             needs:['dumbbell'], reps:[20,35], quality:'engine' },
  { id:'db_clean',      he:'DB Clean & Jerk',            needs:['dumbbell'], reps:[12,24], quality:'grind' },

  // Equipment-specific
  { id:'rope_single',   he:'Single Unders',              needs:['jump_rope'], reps:[60,120], quality:'engine' },
  { id:'rope_double',   he:'Double Unders',              needs:['jump_rope'], reps:[30,60],  quality:'engine' },
  { id:'box_step',      he:'Box Step-ups',               needs:['box'], reps:[20,40], quality:'legs' },
  { id:'box_jump',      he:'Box Jumps',                  needs:['box'], reps:[15,25], quality:'legs' },
  { id:'band_pull',     he:'Band Pull-downs',            needs:['band'], reps:[20,30], quality:'pull', standsFor:'SkiErg' },
  { id:'band_row',      he:'Band Rows',                  needs:['band'], reps:[20,30], quality:'pull', standsFor:'Sled Pull' },
  { id:'pullup',        he:'Pull-ups',                   needs:['bar'], reps:[6,15], quality:'pull' },
  { id:'hang_knee',     he:'Hanging Knee Raises',        needs:['bar'], reps:[12,20], quality:'core' },
  { id:'ski',           he:'SkiErg (מטרים)',             needs:['machine'], reps:[250,750], quality:'engine', station:'SkiErg' },
  { id:'row',           he:'Row (מטרים)',                needs:['machine'], reps:[250,750], quality:'engine', station:'Row' },
  { id:'sled_push',     he:'Sled Push (מטרים)',          needs:['sled'], reps:[20,50], quality:'grind', station:'Sled Push' },
  { id:'sled_pull',     he:'Sled Pull (מטרים)',          needs:['sled'], reps:[20,50], quality:'grind', station:'Sled Pull' },
  { id:'wall_ball',     he:'Wall Balls',                 needs:['wallball'], reps:[20,40], quality:'legs', station:'Wall Balls' },
]

const GYMN_POOL = [
  // Bodyweight foundations
  { id:'pushup',        he:'Push-ups',                   needs:[], reps:[10,25], quality:'push' },
  { id:'pike_pushup',   he:'Pike Push-ups',              needs:[], reps:[8,15],  quality:'push', standsFor:'HSPU' },
  { id:'hollow',        he:'Hollow Hold (שניות)',        needs:[], reps:[20,45], quality:'core' },
  { id:'arch',          he:'Arch Hold (שניות)',          needs:[], reps:[20,45], quality:'core' },
  { id:'hollow_rock',   he:'Hollow Rocks',               needs:[], reps:[20,40], quality:'core' },
  { id:'vup',           he:'V-ups',                      needs:[], reps:[15,25], quality:'core', standsFor:'Toes-to-Bar' },
  { id:'plank',         he:'Plank (שניות)',              needs:[], reps:[30,60], quality:'core' },
  { id:'squat_bw',      he:'Air Squats',                 needs:[], reps:[20,40], quality:'legs' },
  { id:'split_squat',   he:'Bulgarian Split Squat',      needs:[], reps:[10,16], quality:'legs', standsFor:'Pistol' },
  { id:'pistol_assist', he:'Pistol לספסל / נגד קיר',     needs:[], reps:[6,12],  quality:'legs', standsFor:'Pistol Squat' },
  { id:'crab_dip',      he:'Crab Dips',                  needs:[], reps:[12,20], quality:'push', standsFor:'Ring Dips' },
  { id:'burpee',        he:'Burpees',                    needs:[], reps:[10,20], quality:'engine' },
  { id:'superman',      he:'Superman Pulls',             needs:[], reps:[15,25], quality:'pull' },
  { id:'towel_row',     he:'Towel Row (מגבת בדלת)',      needs:[], reps:[12,20], quality:'pull', standsFor:'Ring Row' },

  // Wall
  { id:'wall_hs',       he:'Handstand מול קיר (שניות)',  needs:['wall'], reps:[20,45], quality:'handstand', station:'Handstand Hold' },
  { id:'wall_walk',     he:'Wall Walks',                 needs:['wall'], reps:[3,8],   quality:'handstand', station:'Wall Walk' },
  { id:'wall_hspu',     he:'Wall HSPU',                  needs:['wall'], reps:[4,10],  quality:'push', station:'HSPU' },
  { id:'wall_shoulder', he:'Shoulder Taps בעמידת ידיים', needs:['wall'], reps:[10,20], quality:'handstand' },

  // Bar
  { id:'pullup',        he:'Pull-ups',                   needs:['bar'], reps:[5,12],  quality:'pull', station:'Pull-up' },
  { id:'chinup',        he:'Chin-ups',                   needs:['bar'], reps:[5,12],  quality:'pull' },
  { id:'ttb',           he:'Toes-to-Bar',                needs:['bar'], reps:[8,15],  quality:'core', station:'Toes-to-Bar' },
  { id:'knee_raise',    he:'Hanging Knee Raises',        needs:['bar'], reps:[12,20], quality:'core' },
  { id:'kipswing',      he:'Kip Swings',                 needs:['bar'], reps:[10,20], quality:'pull' },
  { id:'hang',          he:'Dead Hang (שניות)',          needs:['bar'], reps:[20,45], quality:'pull' },
  { id:'bar_mu',        he:'Bar Muscle-ups',             needs:['bar'], reps:[3,8],   quality:'pull', station:'Muscle-up' },

  // Rings
  { id:'ring_row',      he:'Ring Rows',                  needs:['rings'], reps:[10,20], quality:'pull', station:'Ring Row' },
  { id:'ring_dip',      he:'Ring Dips',                  needs:['rings'], reps:[5,12],  quality:'push', station:'Ring Dip' },
  { id:'ring_support',  he:'Ring Support Hold (שניות)',  needs:['rings'], reps:[15,40], quality:'core' },
  { id:'ring_mu',       he:'Ring Muscle-ups',            needs:['rings'], reps:[2,6],   quality:'pull', station:'Muscle-up' },
  { id:'false_grip',    he:'False Grip Hang (שניות)',    needs:['rings'], reps:[15,30], quality:'pull' },

  // Parallettes / dip bars
  { id:'dip',           he:'Dips',                       needs:['parallettes'], reps:[6,14], quality:'push', station:'Dip' },
  { id:'lsit',          he:'L-Sit (שניות)',              needs:['parallettes'], reps:[15,35], quality:'core', station:'L-Sit' },
  { id:'tuck_planche',  he:'Tuck Planche (שניות)',       needs:['parallettes'], reps:[10,25], quality:'core' },

  // Box / band / rope
  { id:'box_pike',      he:'Box Pike Push-ups',          needs:['box'], reps:[8,15],  quality:'push', standsFor:'HSPU' },
  { id:'step_up',       he:'Step-ups',                   needs:['box'], reps:[16,30], quality:'legs' },
  { id:'band_pullup',   he:'Pull-ups עם גומייה',         needs:['band'], reps:[8,15], quality:'pull', standsFor:'Pull-up' },
  { id:'band_pullapart', he:'Band Pull-aparts',          needs:['band'], reps:[20,30], quality:'pull' },
  { id:'rope_climb',    he:'Rope Climbs',                needs:['rope'], reps:[2,5],  quality:'pull', station:'Rope Climb' },
]
